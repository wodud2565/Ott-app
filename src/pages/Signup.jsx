  ...
  return (
    <>
      <div className="w-full h-screen">
        <img className="hidden sm:block absolute w-full h-full object-cover" src="https://assets.nflxext.com/ffe/siteui/vlv3/77d35039-751f-4c3e-9c8d-1240c1ca6188/cf244808-d722-428f-80a9-052acdf158ec/IN-en-20231106-popsignuptwoweeks-perspective_alpha_website_small.jpg" alt="///" />
            ...
            <div className="max-w-[320px] mx-auto py-16">
              ...
              <form onSubmit={handleFormSubmit} className="w-full flex flex-col py-4">
                ...
                <div className="flex justify-between items-center text-gray-600">
                  <p>
                    <input type="checkbox" className="mr-2" checked={rememeberLogin} onChange={(e) => setRememberLogin(!rememeberLogin)} />
                    Remember me
                  </p>
                  <p>Need Help?</p>
                </div>
